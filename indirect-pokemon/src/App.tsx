  ...
  return (
    <div className="mt-3">
      ...
      <div className="grid grid-cols-2">
        ...
        />
        <div className="ml-3">
          <h2 className="text-2xl font-bold">{pokemonData.name.english}</h2>
          <h3 className="text-xl font-bold">{pokemonData.type.join(", ")}</h3>
          <div className="mt-3">
            ...
            <ul className="mt-3">
              {[
                ...
                <li key={stat} className="grid grid-cols-2">
                  ...
                  <span>{pokemonData.base[stat as keyof typeof pokemonData]}</span>
                </li>
              ))}
            </ul>
          </div>
